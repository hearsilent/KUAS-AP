...
public class ProgressWheel extends View {
    ...
    int MaterialColors[] = {R.color.progress_red, R.color.progress_blue, R.color.progress_yellow, R.color.progress_green};
    ...
    private void setupPaints() {
        ...
        shadowPaint.setStrokeWidth(barWidth);
    }
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            ...
            circleBounds = new RectF(xOffset + barWidth + circleDiameter/5,
                    yOffset + barWidth + circleDiameter/5,
                    xOffset + circleDiameter - barWidth - circleDiameter/5,
                    yOffset + circleDiameter - barWidth - circleDiameter/5);
            circleBounds2 = new RectF(xOffset + barWidth,
                    yOffset + barWidth,
                    xOffset + circleDiameter - barWidth,
                    yOffset + circleDiameter - barWidth);

            if (!isCircleBackground)
                circleBounds = circleBounds2;
        } else {
            int xOffset = 0;
            int yOffset = 0;
            int circleDiameter = layout_height;

            if (isCircleBackground)
            {
                if (layout_height > layout_width)
                {
                    yOffset = (layout_height - layout_width)/2;
                    circleDiameter = layout_width;
                }
                else if (layout_height < layout_width)
                {
                    xOffset = (layout_width - layout_height)/2;
                    circleDiameter = layout_height;
                }
            }

            circleBounds = new RectF(paddingLeft + barWidth + circleDiameter/5 + xOffset,
                    paddingTop + barWidth + circleDiameter/5 + yOffset,
                    layout_width - paddingRight - barWidth - circleDiameter/5 - xOffset,
                    layout_height - paddingBottom - barWidth - circleDiameter/5 - yOffset);
            circleBounds2 = new RectF(paddingLeft + barWidth + xOffset,
                    paddingTop + barWidth + yOffset,
                    layout_width - paddingRight - barWidth -  xOffset,
                    layout_height - paddingBottom - barWidth - yOffset);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        {
            if (isShadow)
                canvas.drawCircle(circleBounds2.centerX() + mShadowSize/2, circleBounds2.centerY() + mShadowSize, circleBounds2.width()/2 + mShadowSize/2, shadowPaint);
            canvas.drawCircle(circleBounds2.centerX(), circleBounds2.centerY(), circleBounds2.width()/2, circlePaint);
        }
    ...
    /**
     * Check if the circle background has shadow
     */
     ...
     */
    public void setShadow(boolean _bool) { isShadow = _bool; }

    /**
     * Set the shadow size,
     *
     * @param mShadowSize the shadow size
     */
    public void setShadowSize(float mShadowSize) { this.mShadowSize = mShadowSize; }
     ...
     */
    public void setCircleBackground(boolean _bool) { isCircleBackground = _bool; }
    ...
    /**
     * Sets shadow color of the circle background
     *
     * @param shadowColor The shadow color of the circle background
     */
